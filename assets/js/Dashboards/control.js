(function($) {
    /* Initialize function */
    $.fn.decarbTable = function(options = null) {
        /**
            ...
            **/
            if (
                ...
                Heads.each(function(col) {
                    if (
                        $(this).data("decarbTable") &&
                        $(this).data("decarbTable").dateFormat !== undefined
                    ) {
                        var dateF = $(this).data("decarbTable").dateFormat;
                        dateColumn.push(col);
